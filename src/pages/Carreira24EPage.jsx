...
const Carreira24EPage = () => {
  ...
  // Dados das paragens da Carreira 24E
  const paragens = [
    {
        "nome": "Campolide",
        "lat": 38.73598,
  ...
  const [veiculos, setVeiculos] = useState([
    {
        "chapa": "24E/2",
        "tripulante": "Paulo Rodrigues (18009)",
        "gpsAtivo": false,
        "proximaRendicao": "15:00",
        "paragem": 0
    },
    {
        "chapa": "24E/7",
        "tripulante": "Teresa Silva (18010)",
        "gpsAtivo": false,
  ...
  const [proximaRendicao, setProximaRendicao] = useState({
    ...
    local: "Campolide",
    hora: "16:30",
    tripulanteAtual: "Paulo Rodrigues (18009)"
  });
  ...
  useEffect(() => {
    ...
    const map = L.map(mapRef.current).setView([38.71810666666667, -9.144016666666667], 13);
            ...
            <div className="p-4 bg-gray-50 border-t border-gray-200">
              <div className="space-y-2 text-sm">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span>Terminais (Campolide / Graça)</span>
                </div>
              </div>
            </div>
          </div>
