...
const Carreira15EPage = () => {
  ...
  // Dados das paragens da Carreira 15E
  const paragens = [
    {
        "nome": "Praça da Figueira",
        "lat": 38.71398,
        "lng": -9.13698,
        "ordem": 1
    },
    {
        "nome": "Rua da Conceição",
        "lat": 38.71098,
        "lng": -9.13545,
        "ordem": 2
    },
  ...
  const [veiculos, setVeiculos] = useState([
    {
        "chapa": "15E/3",
        "tripulante": "Carlos Mendes (18004)",
        "gpsAtivo": false,
        "proximaRendicao": "14:00",
        "paragem": 0
    },
    {
        "chapa": "15E/8",
        "tripulante": "Ana Costa (18005)",
        "gpsAtivo": false,
        "proximaRendicao": "15:30",
        "paragem": 3
    },
    {
        "chapa": "15E/12",
        "tripulante": "Rui Santos (18006)",
        "gpsAtivo": false,
        "proximaRendicao": "16:45",
        "paragem": 5
    }
]);
  ...
  const [proximaRendicao, setProximaRendicao] = useState({
    chapa: "15E/3",
    local: "Praça da Figueira",
    hora: "16:30",
    tripulanteAtual: "Carlos Mendes (18004)"
  });
  ...
  useEffect(() => {
    ...
    const map = L.map(mapRef.current).setView([38.70504714285714, -9.166382857142858], 13);
            ...
            <div className="p-4 bg-gray-50 border-t border-gray-200">
              <div className="space-y-2 text-sm">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span>Terminais (Praça da Figueira / Algés)</span>
                </div>
              </div>
            </div>
          </div>
