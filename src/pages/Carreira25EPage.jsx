...
const Carreira25EPage = () => {
  ...
  // Dados das paragens da Carreira 25E
  const paragens = [
    {
        "nome": "Prazeres",
        "lat": 38.71598,
  ...
  const [veiculos, setVeiculos] = useState([
    {
        "chapa": "25E/4",
        "tripulante": "Ricardo Martins (18011)",
        "gpsAtivo": false,
        "proximaRendicao": "14:45",
        "paragem": 2
    },
    {
        "chapa": "25E/11",
        "tripulante": "Luísa Fernandes (18012)",
        "gpsAtivo": false,
  ...
  const [proximaRendicao, setProximaRendicao] = useState({
    ...
    local: "Prazeres",
    hora: "16:30",
    tripulanteAtual: "Ricardo Martins (18011)"
  });
  ...
  useEffect(() => {
    ...
    const map = L.map(mapRef.current).setView([38.712114285714286, -9.148954285714286], 13);
            ...
            <div className="p-4 bg-gray-50 border-t border-gray-200">
              <div className="space-y-2 text-sm">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span>Terminais (Prazeres / Cais do Sodré)</span>
                </div>
              </div>
            </div>
          </div>
