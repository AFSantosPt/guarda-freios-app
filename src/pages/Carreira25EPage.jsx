...
const Carreira25EPage = () => {
  ...
  // Dados fixos das paragens da Carreira 25E
  const paragens = [
    'Prazeres',
    'Estrela',
    'S. Bento',
  ...
  const [veiculos, setVeiculos] = useState([
    { chapa: "4", sentido: "Sodre", posicao: 2, confirmado: true },
    { chapa: "10", sentido: "Prazeres", posicao: 5, confirmado: false },
    { chapa: "13", sentido: "Sodre", posicao: 7, confirmado: true }
  ]);

  // Estado para observações
  const [observacoes, setObservacoes] = useState([
    { autor: "180939", msg: "Tudo a decorrer normalmente na 25E", hora: "14:55 01/10" }
  ]);
      ...
      <main className="p-4 space-y-6">
          ...
          <div className="mt-6 p-4 bg-gray-50 rounded-lg">
            ...
            <div className="flex flex-wrap gap-4 text-xs">
              <div className="flex items-center">
                ...
                <span>🔵 Sentido Cais do Sodré (Confirmado)</span>
              </div>
              <div className="flex items-center">
                <div className="w-4 h-4 bg-red-500 rounded-full mr-2"></div>
                <span>🔴 Sentido Prazeres (Confirmado)</span>
              </div>
              <div className="flex items-center">
        ...
        <div className="bg-white rounded-lg shadow-md p-6">
          ...
          <div className="bg-blue-50 p-4 rounded-lg">
            ...
            <button
              onClick={() => navigate('/chat-carreira?carreira=25E')}
