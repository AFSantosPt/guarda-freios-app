  ...
  const getCarreiraInfo = (carreira) => {
    const info = {
      ...
      '15E': {
        ...
        paragens: 'As principais paragens da Carreira 15E incluem Praça da Figueira, Rossio, Camões, S. Bento, Estrela, Belém e Algés.',
        percurso: 'Percurso: Praça da Figueira ↔ Algés'
      },
      '18E': {
        horario: 'A Carreira 18E funciona das 07:00 às 23:00, com frequência de 10-12 minutos.',
        paragens: 'As principais paragens da Carreira 18E incluem Ajuda, Estrela, S. Bento, Camões, Chiado, Baixa, Martim Moniz, Graça e Senhora do Monte.',
        percurso: 'Percurso: Ajuda ↔ Senhora do Monte'
      },
      '24E': {
        horario: 'A Carreira 24E funciona das 07:30 às 22:30, com frequência de 10-15 minutos.',
        paragens: 'As principais paragens da Carreira 24E incluem Campolide, Amoreiras, Rato, Camões, Chiado, Baixa, Terreiro do Paço e Graça.',
        percurso: 'Percurso: Campolide ↔ Graça'
      },
      '25E': {
        horario: 'A Carreira 25E funciona das 07:00 às 23:00, com frequência de 8-10 minutos.',
        paragens: 'As principais paragens da Carreira 25E incluem Prazeres, Estrela, S. Bento, Camões, Chiado, Baixa, Terreiro do Paço e Cais do Sodré.',
        percurso: 'Percurso: Prazeres ↔ Cais do Sodré'
      },
      '28E': {
        horario: 'A Carreira 28E funciona das 06:00 às 23:30, com frequência de 8-12 minutos.',
        paragens: 'As principais paragens da Carreira 28E incluem Martim Moniz, Graça, S. Vicente, Estrela, Prazeres e Alfama.',
        percurso: 'Percurso circular: Martim Moniz → Graça → Alfama → Estrela → Prazeres → Martim Moniz'
      }
    };
