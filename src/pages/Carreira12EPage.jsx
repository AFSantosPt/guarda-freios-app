...
const Carreira12EPage = () => {
  ...
  const [veiculos, setVeiculos] = useState([
    ...
    { 
      ...
      lng: null,
      gpsAtivo: false,
      paragem: 6, // Posição estimada por horário
      proximaRendicao: "17:00"
    },
    { 
      chapa: "12E/1", 
      tripulante: "Pedro Costa (180939)",
      lat: 38.70898, 
      lng: -9.13945,
      gpsAtivo: true,
      ultimaAtualizacao: new Date(),
      proximaRendicao: "15:45"
    }
  ]);
  ...
  const [observacoes, setObservacoes] = useState([
    { texto: "Cheguei ao Martim Moniz para rendição", hora: "14:41 27/09", autor: "180939", tipo: "checkin" },
    { texto: "Caminho livre em todo o percurso", hora: "14:42 27/09", autor: "18002", tipo: "info" }
  ]);
  ...
  const pararPartilhaGPS = () => {
    ...
    // TODO: Notificar backend que GPS foi desligado
  ...
  useEffect(() => {
    ...
    // Adicionar marcadores para paragens (mais discretos)
  ...
  useEffect(() => {
    ...
    // Remover marcadores antigos de veículos
    map.eachLayer((layer) => {
    ...
    // Adicionar marcador da minha localização se GPS ativo
    if (minhaLocalizacao) {
            ...
            <div className="p-4 bg-gray-50 border-t border-gray-200">
              <div className="space-y-2 text-sm">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span>Terminais (Martim Moniz / Pç. Luís Camões)</span>
                </div>
              </div>
            </div>
          </div>
